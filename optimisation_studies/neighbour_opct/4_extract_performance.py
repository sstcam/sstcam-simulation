...
def main():
    ...
    for path in tqdm(paths):
        with pd.HDFStore(path) as store:
            ...
            self_opct = metadata['self_opct']
            reflected_opct = metadata['reflected_opct']
            reflected_scale = metadata['reflected_scale']
            trigger_threshold = metadata['trigger_threshold']
            pedestal = metadata['pedestal']

            key = (shower_primary_id, self_opct, reflected_opct, reflected_scale)
    ...
    for key in tqdm(keys):
        shower_primary_id, self_opct, reflected_opct, reflected_scale = key
