...
def main():
    ...
    for path in tqdm(paths):
        with pd.HDFStore(path) as store:
            ...
            pulse_name = metadata['pulse_name']
            ...
            key = (shower_primary_id, pulse_name, mv_per_pe, readout_noise_stddev, digitisation_noise_stddev)
    ...
    for key in tqdm(keys):
        shower_primary_id, pulse_name, mv_per_pe, readout_noise_stddev, digitisation_noise_stddev = key
